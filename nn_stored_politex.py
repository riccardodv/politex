...
class Qnet(th.nn.Module):
    ...
    def __init__(
        ...
        self.lin2 = th.nn.Linear(self.hidden_size, self.hidden_size)
        self.lin3 = th.nn.Linear(self.hidden_size, 1)
...
for iter in range(100):
    ...
    if (iter + 1) % 10 == 0:
        ...
        while not done:
            ...
            sum_r += r
        print("eval rewards iter {}/100: {}".format(iter + 1, sum_r))
